...
public class Packet_move extends Comp implements ActionListener{
	...
	public void music()
	{
		...
		{
			try {
				InputStream in = new FileInputStream("Step4m.wav");
				AudioStream as = new AudioStream(in);         
				AudioPlayer.player.start(as);            
				}
				catch(Exception e) {}
		...
		{
			try {
				InputStream in = new FileInputStream("Step5m.wav");
				AudioStream as = new AudioStream(in);         
				AudioPlayer.player.start(as);            
				}
				catch(Exception e) {}
		...
		{
			try {
				InputStream in = new FileInputStream("Step6m.wav");
				AudioStream as = new AudioStream(in);         
				AudioPlayer.player.start(as);            
				}
				catch(Exception e) {}
